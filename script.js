document.addEventListener('DOMContentLoaded', function () {
  ...
  if (animatedElements.length > 0) {
    ...
    styleTag.textContent =
      ...
      '.animate-hidden.fade-in-up{transform:translateY(32px);}' +
      '.animate-hidden.fade-in-down{transform:translateY(-32px);}' +
      '.animate-hidden.fade-in-left{transform:translateX(32px);}' +
      '.animate-hidden.fade-in-right{transform:translateX(-32px);}' +
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a8274abf-ec3d-4c9e-8e7c-dc68a6201a08',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a8274abf-ec3d-4c9e-8e7c-dc68a6201a08';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a8274abf-ec3d-4c9e-8e7c-dc68a6201a08';
